...
{
    /// <summary>
    /// <c>Straight</c> class provides the implementation of a functional conveyor including structural Supports.
    /// </summary>
    public class Straight : BasicStraight
    {
        #region Fields
        ...
        public Straight(StraightInfo info) : base(info)
        {
            _info = info;
            ...
            if (_info.Feeder == null)
            {
                ...
                {
                    System = AuxiliaryData.SystemType.CaseConveying
                };
            }
        ...
        public override ImageSource Image => Common.Icon?.Get("StraightRoller");
        ...
        public override bool Snap(FixPoint stranger, FixPoint local)
        {
            ...
            Matrix4x4.Invert(parent.Orientation, out var inverseWorld);

            ////Only rotate yaw - otherwise the roll will be changed
            Matrix4x4.Invert(local.Orientation * inverseWorld, out var localInvert);
    ...
    [Serializable, XmlInclude(typeof(StraightInfo)), XmlType(TypeName = "Experior.Catalog.CaseConveyingSystem.Assemblies.Conveyors.StraightInfo")]
    public class StraightInfo : BasicStraightInfo
    {
